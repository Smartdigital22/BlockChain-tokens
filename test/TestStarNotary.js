...
it('lets 2 users exchange stars', async() => {
    ...
    let user1 = accounts[1];
    let user2 = accounts[2];
    await instance.createStar('First Awesome Star', tokenId1, {from: user1})
    await instance.createStar('Second Awesome Star', tokenId2, {from: user2})
...
it('lets a user transfer a star', async() => {
    ...
    let user1 = accounts[1];
    // 1. create a Star with different tokenId
    await instance.createStar("KH star", starId, {from: user0});
